...
#if LV_USE_GRID
    LV_STYLE_HELPER(GridColumns, LV_STYLE_GRID_COLUMN_DSC_ARRAY, const int*, colSpec);
    LV_STYLE_HELPER(GridColumnAlignDefault, LV_STYLE_GRID_COLUMN_ALIGN, lv_grid_align_t, align)

    LV_STYLE_HELPER(GridRows, LV_STYLE_GRID_ROW_DSC_ARRAY, const int*, rowSpec);
    LV_STYLE_HELPER(GridRowAlignDefault, LV_STYLE_GRID_ROW_ALIGN, lv_grid_align_t, align)
#endif
